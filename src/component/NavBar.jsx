                ...
                <ul className="flex flex-col gap-5 cursor-pointer">
                    <li>
                        <NavLink to={'/weather'}  className={({ isActive }) => {
                            ...
                            <div className="flex flex-col text-sm gap-2 font-semibold text-center cursor-pointer items-center">
                                <svg className="w-6 h-6" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
                                    ...
                                    <g>
                                        <path className="st0" d="M212.969,278.609c15.938-44.594,56.344-76.75,103.688-82.141c-15.469-44.016-57.375-75.5-106.656-75.5
                                        ...
                                        <rect x="193.516" y="24.047" className="st0" width="32.938" height="63.406"/>
                                        <polygon className="st0" points="117.984,118.734 73.156,73.906 49.859,97.188 94.688,142.031"/>
                                        <rect y="217.563" className="st0" width="63.406" height="32.938"/>
                                        <path className="st0" d="M49.859,370.844l23.266,23.328l17.578-17.594c2.766-14.109,7.969-27.344,15.219-39.266l-11.266-11.266
                                            L49.859,370.844z"/>
                                        <polygon className="st0" points="370.125,97.188 346.813,73.891 302,118.734 325.281,142.031"/>
                                        <path className="st0" d="M422.578,304.344c-9.234-42.828-47.281-74.922-92.859-74.922c-46.063,0-84.438,32.75-93.156,76.25
                    ...
                    <li>
                        <NavLink to='/cities' className={({ isActive }) => isActive ? '[&:nth-child(1)]:stroke-white *:text-white' : '[&:nth-child(1)]:stroke-[#878e97] text-[#878e97]'}>
                            <div className="flex flex-col text-sm gap-2 font-semibold text-center cursor-pointer items-center">
                    ...
                    <li>
                        <NavLink to='/map'>
                            <div className="flex flex-col text-sm gap-2 font-semibold text-center cursor-pointer">
                                <img className="w-6 h-6 mr-auto ml-auto" src="/weather-app-icons/map.png" alt="Image 3" />
                                <p>Map</p>
                            </div>
                        </NavLink>
                    </li>
                    <li>
                        <NavLink to='/settings'>
                            <div className="flex flex-col text-sm gap-2 font-semibold text-center cursor-pointer">
                                <img className="w-6 h-6 mr-auto ml-auto" src="/weather-app-icons/setting.png" alt="Image 4" />
                                <p>Settings</p>
                            </div>
                        </NavLink>
                    </li>
